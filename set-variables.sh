...
sed -i "s~PRECONNECT~$REACT_APP_AUTH_URL~g" build/index.html
sed -i "s~DNS~$REACT_APP_FAMILY_URL~g" build/index.html
...
sed -i "s~FIRST_GLASS_COLOR~$REACT_APP_FIRST_GLASS_COLOR~g" build/index.html
...
sed -i "s~PASS_COLOR~$REACT_APP_PASS_COLOR~g" build/index.html
sed -i "s~FIRST_BACKGROUND_COLOR~$REACT_APP_FIRST_BACKGROUND_COLOR~g" build/index.html
sed -i "s~FIRST_BACKGROUND_DARK_COLOR~$REACT_APP_FIRST_BACKGROUND_DARK_COLOR~g" build/index.html
